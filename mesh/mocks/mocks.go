...
func (m *MockvmState) Apply(arg0 vm.ApplyContext, arg1 []types.Transaction, arg2 []types.CoinbaseReward, arg3 []types.AnyReward) ([]types.Transaction, []types.TransactionWithResult, error) {
	m.ctrl.T.Helper()
