...
func (m *MockstreamRequester) Run(arg0 context.Context) error {
	m.ctrl.T.Helper()
...
func (mr *MockstreamRequesterMockRecorder) Run(arg0 any) *MockstreamRequesterRunCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Run", reflect.TypeOf((*MockstreamRequester)(nil).Run), arg0)
