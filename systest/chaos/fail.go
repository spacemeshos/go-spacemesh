...
func Fail(ctx context.Context, tctx *testcontext.Context, name string, pods ...string) (Teardown, error) {
	fail := chaos.PodChaos{}
	fail.Name = name
	fail.Namespace = tctx.Namespace
	...
	if err := tctx.Generic.Create(ctx, &fail); err != nil {
		return nil, err
	}
	return func(ctx context.Context) error {
		return tctx.Generic.Delete(ctx, &fail)
	}, nil
}
