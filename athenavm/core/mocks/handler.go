...
// Source: github.com/spacemeshos/go-spacemesh/athenavm/core (interfaces: Handler)
//
// Generated by this command:
//
//	mockgen -typed -package=mocks -destination=./mocks/handler.go github.com/spacemeshos/go-spacemesh/athenavm/core Handler
//
