...
func (*Marker) Items() []Ordered { return nil }
...
func (m *EmptyRangeMessage) Items() []Ordered  { return nil }
...
func (m *FingerprintMessage) Items() []Ordered  { return nil }
...
func (m *ItemBatchMessage) Items() []Ordered {
	r := make([]Ordered, len(m.Contents))
	for n, item := range m.Contents {
		r[n] = item
	}
	return r
}
