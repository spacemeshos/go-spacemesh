...
func TestBallot_BallotsNotAvailable(t *testing.T) {
	...
	th.mf.EXPECT().GetBallots(gomock.Any(), p2p.AnyPeer(), []types.BallotID{b.Votes.Base, b.RefBallot}).Return(errUnknown).Times(1)
...
func TestBallot_ATXsNotAvailable(t *testing.T) {
	...
	data := encodeBallot(t, b)
	th.mm.EXPECT().HasBallot(b.ID()).Return(false).Times(1)
	th.mf.EXPECT().GetBallots(gomock.Any(), p2p.AnyPeer(), []types.BallotID{b.Votes.Base, b.RefBallot}).Return(nil).Times(1)
	errUnknown := errors.New("unknown")
	th.mf.EXPECT().GetAtxs(gomock.Any(), p2p.AnyPeer(), types.ATXIDList{b.AtxID}).Return(errUnknown).Times(1)
	assert.ErrorIs(t, th.HandleBallotData(context.TODO(), data), errUnknown)
}
...
func TestBallot_BlocksNotAvailable(t *testing.T) {
	...
	th.mm.EXPECT().HasBallot(b.ID()).Return(false).Times(1)
	th.mf.EXPECT().GetBallots(gomock.Any(), p2p.AnyPeer(), []types.BallotID{b.Votes.Base, b.RefBallot}).Return(nil).Times(1)
	th.mf.EXPECT().GetAtxs(gomock.Any(), p2p.AnyPeer(), types.ATXIDList{b.AtxID}).Return(nil).Times(1)
	errUnknown := errors.New("unknown")
	th.mf.EXPECT().GetBlocks(gomock.Any(), p2p.AnyPeer(), b.Votes.Support).Return(errUnknown).Times(1)
	assert.ErrorIs(t, th.HandleBallotData(context.TODO(), data), errUnknown)
}
...
func TestBallot_ErrorCheckingEligible(t *testing.T) {
	...
	th.mf.EXPECT().GetBallots(gomock.Any(), p2p.AnyPeer(), []types.BallotID{b.Votes.Base, b.RefBallot}).Return(nil).Times(1)
	th.mf.EXPECT().GetAtxs(gomock.Any(), p2p.AnyPeer(), types.ATXIDList{b.AtxID}).Return(nil).Times(1)
	th.mf.EXPECT().GetBlocks(gomock.Any(), p2p.AnyPeer(), b.Votes.Support).Return(nil).Times(1)
...
func TestBallot_RefBallot(t *testing.T) {
	...
	data := encodeBallot(t, b)
	th.mm.EXPECT().HasBallot(b.ID()).Return(false).Times(1)
	th.mf.EXPECT().GetBallots(gomock.Any(), p2p.AnyPeer(), []types.BallotID{b.Votes.Base}).Return(nil).Times(1)
	atxIDs := types.ATXIDList{b.AtxID}
	atxIDs = append(atxIDs, b.EpochData.ActiveSet...)
	th.mf.EXPECT().GetAtxs(gomock.Any(), p2p.AnyPeer(), atxIDs).Return(nil).Times(1)
	th.mf.EXPECT().GetBlocks(gomock.Any(), p2p.AnyPeer(), b.Votes.Support).Return(nil).Times(1)
	th.mv.EXPECT().CheckEligibility(gomock.Any(), gomock.Any()).DoAndReturn(
		func(_ context.Context, ballot *types.Ballot) (bool, error) {
			assert.Equal(t, b.ID(), ballot.ID())
...
func TestProposal_FailedToAddBallot(t *testing.T) {
	...
	th.mf.EXPECT().GetBallots(gomock.Any(), p2p.AnyPeer(), []types.BallotID{p.Votes.Base, p.RefBallot}).Return(nil).Times(1)
	th.mf.EXPECT().GetAtxs(gomock.Any(), p2p.AnyPeer(), types.ATXIDList{p.AtxID}).Return(nil).Times(1)
	th.mf.EXPECT().GetBlocks(gomock.Any(), p2p.AnyPeer(), p.Votes.Support).Return(nil).Times(1)
	th.mv.EXPECT().CheckEligibility(gomock.Any(), gomock.Any()).DoAndReturn(
		func(ctx context.Context, ballot *types.Ballot) (bool, error) {
...
func TestProposal_TXsNotAvailable(t *testing.T) {
	...
	th.mm.EXPECT().AddBallot(&p.Ballot).Return(nil).Times(1)
	errUnknown := errors.New("unknown")
	th.mf.EXPECT().GetTxs(gomock.Any(), p2p.AnyPeer(), p.TxIDs).Return(errUnknown).Times(1)
	assert.ErrorIs(t, th.HandleProposalData(context.TODO(), data), errUnknown)
}
...
func TestProposal_FailedToAddProposal(t *testing.T) {
	...
	th.mm.EXPECT().AddBallot(&p.Ballot).Return(nil).Times(1)
	th.mf.EXPECT().GetTxs(gomock.Any(), p2p.AnyPeer(), p.TxIDs).Return(nil).Times(1)
	errUnknown := errors.New("unknown")
