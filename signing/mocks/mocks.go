...
func (m *MockVerifier) Extract(msg, sig []byte) (*signing.PublicKey, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVerifierMockRecorder) Extract(msg, sig interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Extract", reflect.TypeOf((*MockVerifier)(nil).Extract), msg, sig)
}
