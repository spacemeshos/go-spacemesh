...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v p2p/test_p2p.py --tc-file=p2p/config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v test_bs.py --tc-file=config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v hare/test_hare.py::test_hare_sanity --tc-file=hare/config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v sync/test_sync.py --tc-file=sync/config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v late_nodes/test_delayed.py --tc-file=late_nodes/delayed_config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v sync/genesis/test_genesis_voting.py --tc-file=sync/genesis/config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v block_atx/add_node/test_blocks_add_node.py --tc-file=block_atx/add_node/config.yaml --tc-format=yaml --is-dump=true
...
ifndef ES_PASSWD
	...
	$(DOCKERRUN) pytest -s -v block_atx/remove_node/test_blocks_remove_node.py --tc-file=block_atx/remove_node/config.yaml --tc-format=yaml --is-dump=true
