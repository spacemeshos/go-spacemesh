...
from tests.setup_network import setup_network_with_state
...
def test_transactions(init_session, setup_network_with_state):
...
def test_mining(init_session, setup_network_with_state):
    ...
    total_pods = len(setup_network_with_state.get_clients_pods()) + len(setup_network_with_state.bootstrap.pods)
