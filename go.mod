...
replace github.com/spacemeshos/api/release/go v1.18.0 => github.com/spacemeshos/api/release/go v1.18.1-0.20230816104005-22d94455c4b9
...
require (
	...
	github.com/spacemeshos/poet v0.8.8
