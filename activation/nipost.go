...
type PoetProvingServiceClient interface {
	...
	Submit(context.Context, []byte, signing.EdSignature) (*types.PoetRound, error)
...
func (nb *NIPostBuilder) submitPoetChallenge(ctx context.Context, poet PoetProvingServiceClient, challenge []byte, signature signing.EdSignature) (*types.PoetRequest, error) {
...
func (nb *NIPostBuilder) submitPoetChallenges(ctx context.Context, challenge []byte, signature signing.EdSignature) []types.PoetRequest {
