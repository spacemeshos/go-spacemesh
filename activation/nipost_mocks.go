...
func (mr *MockPoetProvingServiceClientMockRecorder) PoetServiceID(arg0 interface{}) *PoetProvingServiceClientPoetServiceIDCall {
...
func (mr *MockPoetProvingServiceClientMockRecorder) PowParams(ctx interface{}) *PoetProvingServiceClientPowParamsCall {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPoetProvingServiceClientMockRecorder) Proof(ctx, roundID interface{}) *PoetProvingServiceClientProofCall {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockPoetProvingServiceClientMockRecorder) Submit(ctx, prefix, challenge, signature, nodeID, pow interface{}) *PoetProvingServiceClientSubmitCall {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockpoetDbAPIMockRecorder) GetProof(arg0 interface{}) *poetDbAPIGetProofCall {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockpoetDbAPIMockRecorder) ValidateAndStore(ctx, proofMessage interface{}) *poetDbAPIValidateAndStoreCall {
	mr.mock.ctrl.T.Helper()
