...
func layerIdsReqFactory(lyr types.LayerID) requestFactory {
	return func(s networker, peer p2ppeers.Peer) (chan interface{}, error) {
		...
		if err := s.SendRequest(context.TODO(), layerIdsMsg, lyr.Bytes(), peer, foo, func(err error) {}); err != nil {
			return nil, err
		}
		return ch, nil
	}
...
func getEpochAtxIds(epoch types.EpochID, s networker, peer p2ppeers.Peer) (chan interface{}, error) {
	...
	if err := s.SendRequest(context.TODO(), atxIdsMsg, epoch.ToBytes(), peer, foo, func(err error) {}); err != nil {
		return nil, err
	}
	return ch, nil
}
...
func hashReqFactory(lyr types.LayerID) requestFactory {
	return func(s networker, peer p2ppeers.Peer) (chan interface{}, error) {
		...
		if err := s.SendRequest(context.TODO(), layerHashMsg, lyr.Bytes(), peer, foo, func(err error) {}); err != nil {
			return nil, err
		}
...
func atxHashReqFactory(ep types.EpochID) requestFactory {
	return func(s networker, peer p2ppeers.Peer) (chan interface{}, error) {
		...
		if err := s.SendRequest(context.TODO(), atxIdrHashMsg, ep.ToBytes(), peer, foo, func(err error) {}); err != nil {
			return nil, err
		}
...
func poetReqFactory(poetProofRef []byte) requestFactory {
	return func(s networker, peer p2ppeers.Peer) (chan interface{}, error) {
		...
		if err := s.SendRequest(context.TODO(), poetMsg, poetProofRef, peer, resHandler, func(err error) {}); err != nil {
			return nil, err
		}
...
func encodeAndSendRequest(req server.MessageType, ids []types.Hash32, s networker, peer p2ppeers.Peer, foo func(msg []byte)) error {
	...
	if err := s.SendRequest(context.TODO(), req, bts, peer, foo, func(err error) {}); err != nil {
		return err
	}
	return nil
}
