...
func TestBlockListener_ListenToGossipBlocks(t *testing.T) {
	...
	atx := types.NewActivationTx(types.NodeId{"whatwhatwhatwhat", []byte("bbb")}, coinbase, 0, types.AtxId{}, 5, 1, types.AtxId{}, 0, []types.BlockID{1, 2, 3}, nipst.NewNIPSTWithChallenge(&common.Hash{}))
