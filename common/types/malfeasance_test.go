...
func TestCodec_MultipleATXs(t *testing.T) {
	...
	a1 := types.NewActivationTx(
		types.NIPostChallenge{PublishEpoch: epoch}, types.Address{1, 2, 3}, types.NIPost{}, 10, nil)
	a2 := types.NewActivationTx(
		types.NIPostChallenge{PublishEpoch: epoch}, types.Address{3, 2, 1}, types.NIPost{}, 11, nil)
