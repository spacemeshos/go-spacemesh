...
//
//	mockgen -typed -package=sync2_test -destination=./mocks_test.go -source=./interface.go -exclude_interfaces itemID
//
...
// CreateATXSync mocks base method.
func (m *MockHashSyncSource) CreateATXSync(name string, cfg sync2.Config, epoch types.EpochID) (sync2.HashSync, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateATXSync", name, cfg, epoch)
	ret0, _ := ret[0].(sync2.HashSync)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateATXSync indicates an expected call of CreateATXSync.
func (mr *MockHashSyncSourceMockRecorder) CreateATXSync(name, cfg, epoch any) *MockHashSyncSourceCreateATXSyncCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateATXSync", reflect.TypeOf((*MockHashSyncSource)(nil).CreateATXSync), name, cfg, epoch)
	return &MockHashSyncSourceCreateATXSyncCall{Call: call}
}

// MockHashSyncSourceCreateATXSyncCall wrap *gomock.Call
type MockHashSyncSourceCreateATXSyncCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockHashSyncSourceCreateATXSyncCall) Return(arg0 sync2.HashSync, arg1 error) *MockHashSyncSourceCreateATXSyncCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockHashSyncSourceCreateATXSyncCall) Do(f func(string, sync2.Config, types.EpochID) (sync2.HashSync, error)) *MockHashSyncSourceCreateATXSyncCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockHashSyncSourceCreateATXSyncCall) DoAndReturn(f func(string, sync2.Config, types.EpochID) (sync2.HashSync, error)) *MockHashSyncSourceCreateATXSyncCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
type MockHandler[T sync2.ItemID] struct {
	ctrl     *gomock.Controller
...
type MockHandlerMockRecorder[T sync2.ItemID] struct {
	mock *MockHandler[T]
}

// NewMockHandler creates a new mock instance.
func NewMockHandler[T sync2.ItemID](ctrl *gomock.Controller) *MockHandler[T] {
...
func (m *MockHandler[T]) Get(ctx context.Context, ids []T, callback func(T, error)) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, ids, callback)
	ret0, _ := ret[0].(error)
	return ret0
}

// Get indicates an expected call of Get.
func (mr *MockHandlerMockRecorder[T]) Get(ctx, ids, callback any) *MockHandlerGetCall[T] {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockHandler[T])(nil).Get), ctx, ids, callback)
	return &MockHandlerGetCall[T]{Call: call}
}

// MockHandlerGetCall wrap *gomock.Call
type MockHandlerGetCall[T sync2.ItemID] struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockHandlerGetCall[T]) Return(arg0 error) *MockHandlerGetCall[T] {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockHandlerGetCall[T]) Do(f func(context.Context, []T, func(T, error)) error) *MockHandlerGetCall[T] {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockHandlerGetCall[T]) DoAndReturn(f func(context.Context, []T, func(T, error)) error) *MockHandlerGetCall[T] {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Register mocks base method.
func (m *MockHandler[T]) Register(peer p2p.Peer, k rangesync.KeyBytes) T {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Register", peer, k)
	ret0, _ := ret[0].(T)
	return ret0
}

// Register indicates an expected call of Register.
func (mr *MockHandlerMockRecorder[T]) Register(peer, k any) *MockHandlerRegisterCall[T] {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Register", reflect.TypeOf((*MockHandler[T])(nil).Register), peer, k)
	return &MockHandlerRegisterCall[T]{Call: call}
}

// MockHandlerRegisterCall wrap *gomock.Call
type MockHandlerRegisterCall[T sync2.ItemID] struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockHandlerRegisterCall[T]) Return(arg0 T) *MockHandlerRegisterCall[T] {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockHandlerRegisterCall[T]) Do(f func(p2p.Peer, rangesync.KeyBytes) T) *MockHandlerRegisterCall[T] {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockHandlerRegisterCall[T]) DoAndReturn(f func(p2p.Peer, rangesync.KeyBytes) T) *MockHandlerRegisterCall[T] {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
