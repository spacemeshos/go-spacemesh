...
//
//	mockgen -typed -package=mocks -destination=./mocks/mocks.go -source=./interface.go -exclude_interfaces=SyncMessage,Conduit
//
...
func (m *MockOrderedSet) Add(ctx context.Context, k types.KeyBytes) error {
	m.ctrl.T.Helper()
...
func (c *MockOrderedSetAddCall) Do(f func(context.Context, types.KeyBytes) error) *MockOrderedSetAddCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockOrderedSetAddCall) DoAndReturn(f func(context.Context, types.KeyBytes) error) *MockOrderedSetAddCall {
...
func (m *MockOrderedSet) GetRangeInfo(ctx context.Context, x, y types.KeyBytes, count int) (rangesync.RangeInfo, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockOrderedSetGetRangeInfoCall) Do(f func(context.Context, types.KeyBytes, types.KeyBytes, int) (rangesync.RangeInfo, error)) *MockOrderedSetGetRangeInfoCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockOrderedSetGetRangeInfoCall) DoAndReturn(f func(context.Context, types.KeyBytes, types.KeyBytes, int) (rangesync.RangeInfo, error)) *MockOrderedSetGetRangeInfoCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockOrderedSet) SplitRange(ctx context.Context, x, y types.KeyBytes, count int) (rangesync.SplitInfo, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockOrderedSetSplitRangeCall) Do(f func(context.Context, types.KeyBytes, types.KeyBytes, int) (rangesync.SplitInfo, error)) *MockOrderedSetSplitRangeCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockOrderedSetSplitRangeCall) DoAndReturn(f func(context.Context, types.KeyBytes, types.KeyBytes, int) (rangesync.SplitInfo, error)) *MockOrderedSetSplitRangeCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
