...
func init() {
	...
	RootCmd.PersistentFlags().IntVar(&config.P2P.SwarmConfig.MaxNearestNodesResults, "max-near-node",
		config.P2P.SwarmConfig.MaxNearestNodesResults, "The maximum nearest node")	
