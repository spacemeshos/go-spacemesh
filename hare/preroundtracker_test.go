...
func TestPreRoundTracker_OnPreRound(t *testing.T) {
	...
	et.Track(m4.NodeID.Bytes(), m4.Round, m4.Eligibility.Count, true)
...
func TestPreRoundTracker_UpdateSet(t *testing.T) {
	...
	et.Track(prMsg1.NodeID.Bytes(), prMsg1.Round, prMsg1.Eligibility.Count, true)
	tracker.OnPreRound(context.Background(), prMsg1)
	prMsg2 := BuildPreRoundMsg(sig2, s2, nil)
	et.Track(prMsg2.NodeID.Bytes(), prMsg2.Round, prMsg2.Eligibility.Count, true)
