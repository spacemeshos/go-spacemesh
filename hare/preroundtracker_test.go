...
var (
	...
	sig0a7 = types.VrfSignature{
		0x00, 0x0a, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
func TestPreRoundTracker_BestVRF(t *testing.T) {
	...
	r.Equal(tracker.bestVRF, biggest, "expected initial best VRF to be max uint32")
	s1 := NewSetFromValues(types.ProposalID{1}, types.ProposalID{2})
