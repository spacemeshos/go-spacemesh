...
func (*ConsensusMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_cf0b91dfc9187dab, []int{0}
}
...
func (*MessageData) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_cf0b91dfc9187dab, []int{1}
}
...
func (*Validator) Descriptor() ([]byte, []int) {
	return fileDescriptor_messages_cf0b91dfc9187dab, []int{2}
}
...
func init() {
	proto.RegisterFile("consensus/pb/messages.proto", fileDescriptor_messages_cf0b91dfc9187dab)
}

var fileDescriptor_messages_cf0b91dfc9187dab = []byte{
