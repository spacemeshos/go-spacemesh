...
type ServerInterface interface {
	...
	GetHareWeightNodeIdEpoch(w http.ResponseWriter, r *http.Request, nodeId externalRef0.Bytes32Hex, epoch externalRef0.EpochID)
...
// GetHareWeightNodeIdEpoch operation middleware
func (sh *strictHandler) GetHareWeightNodeIdEpoch(w http.ResponseWriter, r *http.Request, nodeId externalRef0.Bytes32Hex, epoch externalRef0.EpochID) {
