...
<<<<<<< HEAD
// Source: github.com/spacemeshos/go-spacemesh/api (interfaces: NetworkIdentity,AtxProvider,PostSetupProvider,ChallengeVerifier,ActivationAPI)
=======
// Source: github.com/spacemeshos/go-spacemesh/api (interfaces: NetworkIdentity,AtxProvider,PostSetupProvider)
>>>>>>> develop
...
// MockActivationAPI is a mock of ActivationAPI interface.
type MockActivationAPI struct {
	ctrl     *gomock.Controller
	recorder *MockActivationAPIMockRecorder
}

// MockActivationAPIMockRecorder is the mock recorder for MockActivationAPI.
type MockActivationAPIMockRecorder struct {
	mock *MockActivationAPI
}

// NewMockActivationAPI creates a new mock instance.
func NewMockActivationAPI(ctrl *gomock.Controller) *MockActivationAPI {
	mock := &MockActivationAPI{ctrl: ctrl}
	mock.recorder = &MockActivationAPIMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockActivationAPI) EXPECT() *MockActivationAPIMockRecorder {
	return m.recorder
}

// UpdatePoETServers mocks base method.
func (m *MockActivationAPI) UpdatePoETServers(arg0 context.Context, arg1 []string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdatePoETServers", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// UpdatePoETServers indicates an expected call of UpdatePoETServers.
func (mr *MockActivationAPIMockRecorder) UpdatePoETServers(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdatePoETServers", reflect.TypeOf((*MockActivationAPI)(nil).UpdatePoETServers), arg0, arg1)
}
=======
>>>>>>> develop
