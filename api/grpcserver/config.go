...
const (
	...
	SmeshingIdentitiesV2Alpha1 Service = "smeshing_identities_v2alpha1"
...
func DefaultConfig() Config {
	return Config{
		PublicServices: []Service{
			...
			AccountV2Alpha1, MalfeasanceV2Alpha1, SmeshingIdentitiesV2Alpha1,
