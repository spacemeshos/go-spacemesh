...
// MockCheckpointRunner is a mock of CheckpointRunner interface.
type MockCheckpointRunner struct {
	ctrl     *gomock.Controller
	recorder *MockCheckpointRunnerMockRecorder
}

// MockCheckpointRunnerMockRecorder is the mock recorder for MockCheckpointRunner.
type MockCheckpointRunnerMockRecorder struct {
	mock *MockCheckpointRunner
}

// NewMockCheckpointRunner creates a new mock instance.
func NewMockCheckpointRunner(ctrl *gomock.Controller) *MockCheckpointRunner {
	mock := &MockCheckpointRunner{ctrl: ctrl}
	mock.recorder = &MockCheckpointRunnerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockCheckpointRunner) EXPECT() *MockCheckpointRunnerMockRecorder {
	return m.recorder
}
...
func (mr *MockCheckpointRunnerMockRecorder) Generate(arg0, arg1, arg2 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Generate", reflect.TypeOf((*MockCheckpointRunner)(nil).Generate), arg0, arg1, arg2)
}
