...
func TestRewardService_List(t *testing.T) {
	...
	t.Run("limit set too high", func(t *testing.T) {
		client, _ := setup(t)
		_, err := client.List(t.Context(), &spacemeshv2alpha1.RewardRequest{Limit: 200})
		require.Error(t, err)
	...
	t.Run("no limit set", func(t *testing.T) {
		client, _ := setup(t)
		_, err := client.List(t.Context(), &spacemeshv2alpha1.RewardRequest{})
		require.Error(t, err)
	...
	t.Run("limit and offset", func(t *testing.T) {
		client, _ := setup(t)
		list, err := client.List(t.Context(), &spacemeshv2alpha1.RewardRequest{
			Limit:  25,
			Offset: 50,
		})
	...
	t.Run("all", func(t *testing.T) {
		client, rwds := setup(t)
		list, err := client.List(t.Context(), &spacemeshv2alpha1.RewardRequest{Limit: 100})
		require.NoError(t, err)
...
func TestRewardStreamService_Stream(t *testing.T) {
	...
	t.Run("all", func(t *testing.T) {
		...
		stream, err := client.Stream(t.Context(), &spacemeshv2alpha1.RewardStreamRequest{})
		require.NoError(t, err)
