...
func TestMalfeasanceService_List(t *testing.T) {
	...
	t.Run("limit set too high", func(t *testing.T) {
		...
		_, err := client.List(t.Context(), &spacemeshv2alpha1.MalfeasanceRequest{Limit: 200})
		require.Error(t, err)
	...
	t.Run("no limit set", func(t *testing.T) {
		client := spacemeshv2alpha1.NewMalfeasanceServiceClient(dialGrpc(t, cfg))
		_, err := client.List(t.Context(), &spacemeshv2alpha1.MalfeasanceRequest{})
		require.Error(t, err)
	...
	t.Run("limit and offset", func(t *testing.T) {
		client := spacemeshv2alpha1.NewMalfeasanceServiceClient(dialGrpc(t, cfg))
		list, err := client.List(t.Context(), &spacemeshv2alpha1.MalfeasanceRequest{
			Limit:  25,
			Offset: 50,
		})
		require.NoError(t, err)
	...
	t.Run("all", func(t *testing.T) {
		client := spacemeshv2alpha1.NewMalfeasanceServiceClient(dialGrpc(t, cfg))
		list, err := client.List(t.Context(), &spacemeshv2alpha1.MalfeasanceRequest{Limit: 100})
		require.NoError(t, err)
...
func TestMalfeasanceStreamService_Stream(t *testing.T) {
	...
	t.Run("all", func(t *testing.T) {
		...
		stream, err := client.Stream(t.Context(), &spacemeshv2alpha1.MalfeasanceStreamRequest{})
		require.NoError(t, err)
