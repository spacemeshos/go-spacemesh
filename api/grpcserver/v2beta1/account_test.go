...
func TestAccountService_List(t *testing.T) {
	...
	conn := dialGrpc(t, cfg)
	client := spacemeshv2beta1.NewAccountServiceClient(conn)

	t.Run("limit set too high", func(t *testing.T) {
		_, err := client.List(ctx, &spacemeshv2beta1.AccountRequest{Limit: 200})
		require.Error(t, err)
	...
	t.Run("no limit set", func(t *testing.T) {
		_, err := client.List(ctx, &spacemeshv2beta1.AccountRequest{})
		require.Error(t, err)
	...
	t.Run("limit and offset", func(t *testing.T) {
		list, err := client.List(ctx, &spacemeshv2beta1.AccountRequest{
			Limit:  25,
			Offset: 50,
		})
	...
	t.Run("all", func(t *testing.T) {
		list, err := client.List(ctx, &spacemeshv2beta1.AccountRequest{Limit: 100})
		require.NoError(t, err)
