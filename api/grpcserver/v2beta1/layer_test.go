...
func TestLayerService_List(t *testing.T) {
	...
	t.Run("limit set too high", func(t *testing.T) {
		client := setup(t)
		_, err := client.List(t.Context(), &spacemeshv2beta1.LayerRequest{Limit: 200})
		require.Error(t, err)
	...
	t.Run("no limit set", func(t *testing.T) {
		client := setup(t)
		_, err := client.List(t.Context(), &spacemeshv2beta1.LayerRequest{})
		require.Error(t, err)
	...
	t.Run("limit and offset", func(t *testing.T) {
		client := setup(t)
		list, err := client.List(t.Context(), &spacemeshv2beta1.LayerRequest{
			Limit:  25,
			Offset: 50,
		})
		require.NoError(t, err)
	...
	t.Run("all", func(t *testing.T) {
		client := setup(t)
		ls, err := client.List(t.Context(), &spacemeshv2beta1.LayerRequest{
			StartLayer: 0,
			EndLayer:   100,
			Limit:      100,
		})
...
func TestLayerStreamService_Stream(t *testing.T) {
	...
	t.Run("all", func(t *testing.T) {
		...
		stream, err := client.Stream(t.Context(), &spacemeshv2beta1.LayerStreamRequest{})
		require.NoError(t, err)
