...
func TestActivationService_List(t *testing.T) {
	...
	t.Run("limit set too high", func(t *testing.T) {
		client, _ := setup(t)
		_, err := client.List(t.Context(), &spacemeshv2beta1.ActivationRequest{Limit: 200})
		require.Error(t, err)
	...
	t.Run("no limit set", func(t *testing.T) {
		client, _ := setup(t)
		_, err := client.List(t.Context(), &spacemeshv2beta1.ActivationRequest{})
		require.Error(t, err)
	...
	t.Run("limit and offset", func(t *testing.T) {
		client, _ := setup(t)
		list, err := client.List(t.Context(), &spacemeshv2beta1.ActivationRequest{
			Limit:  25,
			Offset: 50,
		})
	...
	t.Run("all", func(t *testing.T) {
		...
		list, err := client.List(t.Context(), &spacemeshv2beta1.ActivationRequest{Limit: 100})
		require.NoError(t, err)
...
func TestActivationStreamService_Stream(t *testing.T) {
	...
	t.Run("all", func(t *testing.T) {
		...
		stream, err := client.Stream(t.Context(), &spacemeshv2beta1.ActivationStreamRequest{})
		require.NoError(t, err)
