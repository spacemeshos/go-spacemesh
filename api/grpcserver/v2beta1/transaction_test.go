...
func TestTransactionService_List(t *testing.T) {
	...
	t.Run("limit set too high", func(t *testing.T) {
		_, err := client.List(ctx, &spacemeshv2beta1.TransactionRequest{Limit: 200})
		require.Error(t, err)
	...
	t.Run("no limit set", func(t *testing.T) {
		_, err := client.List(ctx, &spacemeshv2beta1.TransactionRequest{})
		require.Error(t, err)
	...
	t.Run("limit and offset", func(t *testing.T) {
		list, err := client.List(ctx, &spacemeshv2beta1.TransactionRequest{Limit: 25, Offset: 50})
		require.NoError(t, err)
		require.Len(t, list.Transactions, 25)
	})

	t.Run("all", func(t *testing.T) {
		list, err := client.List(ctx, &spacemeshv2beta1.TransactionRequest{Limit: 100})
		require.NoError(t, err)
	...
	t.Run("address", func(t *testing.T) {
		...
		list, err := client.List(ctx, &spacemeshv2beta1.TransactionRequest{
			Address: &address,
			Limit:   100,
		})
		require.NoError(t, err)
	...
	t.Run("tx id include result", func(t *testing.T) {
		...
		require.Equal(t, spacemeshv2beta1.TransactionResult_TRANSACTION_STATUS_SUCCESS,
...
func TestTransactionService_EstimateGas(t *testing.T) {
	...
	t.Run("valid tx", func(t *testing.T) {
		resp, err := client.EstimateGas(ctx, &spacemeshv2beta1.EstimateGasRequest{
	...
	t.Run("malformed tx", func(t *testing.T) {
		_, err := client.EstimateGas(ctx, &spacemeshv2beta1.EstimateGasRequest{
...
func TestTransactionService_ParseTransaction(t *testing.T) {
	...
	t.Run("valid tx", func(t *testing.T) {
		resp, err := client.ParseTransaction(ctx, &spacemeshv2beta1.ParseTransactionRequest{
			Transaction: wallet.Spend(keys[0], accounts[3].Address, 100, 0),
		})
		require.NoError(t, err)
	...
	t.Run("malformed tx", func(t *testing.T) {
		_, err := client.ParseTransaction(ctx, &spacemeshv2beta1.ParseTransactionRequest{
			Transaction: []byte("malformed"),
		})
		s, ok := status.FromError(err)
		require.True(t, ok)
...
func TestTransactionServiceSubmitUnsync(t *testing.T) {
	...
	res, err := c.SubmitTransaction(ctx, &spacemeshv2beta1.SubmitTransactionRequest{Transaction: serializedTx})
	req.Error(err)
	...
	_, err = c.SubmitTransaction(ctx, &spacemeshv2beta1.SubmitTransactionRequest{Transaction: serializedTx})
	req.NoError(err)
}
...
func TestTransactionService_SubmitNoConcurrency(t *testing.T) {
	...
	tx := newTx(0, addr, signer)
	for range numTxs {
		res, err := c.SubmitTransaction(ctx, &spacemeshv2beta1.SubmitTransactionRequest{
			Transaction: tx.Raw,
		})
		require.NoError(t, err)
...
func TestToTxContents(t *testing.T) {
	...
	t.Run("singlesig spawn", func(t *testing.T) {
		...
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_SINGLE_SIG_SPAWN, txType)
	})
	...
	t.Run("singlesig send", func(t *testing.T) {
		...
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_SINGLE_SIG_SEND, txType)
	})
	...
	t.Run("multisig spawn", func(t *testing.T) {
		...
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_MULTI_SIG_SPAWN, txType)
	})
	...
	t.Run("multisig send", func(t *testing.T) {
		...
		require.Nil(t, contents.GetVaultSpawn())
		require.Nil(t, contents.GetDrainVault())
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_MULTI_SIG_SEND, txType)
	})
	...
	t.Run("vault spawn", func(t *testing.T) {
		...
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_VAULT_SPAWN, txType)
	})
	...
	t.Run("drain vault", func(t *testing.T) {
		...
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_DRAIN_VAULT, txType)
	})
	...
	t.Run("multisig vesting spawn", func(t *testing.T) {
		...
		require.Nil(t, contents.GetVaultSpawn())
		require.Nil(t, contents.GetDrainVault())
		require.Equal(t, spacemeshv2beta1.Transaction_TRANSACTION_TYPE_VESTING_SPAWN, txType)
	})
}
...
func TestEvictedTransaction(t *testing.T) {
	...
	req.Equal(list.Transactions[0].TxState.String(),
		spacemeshv2beta1.TransactionState_TRANSACTION_STATE_INEFFECTUAL.String())
}
