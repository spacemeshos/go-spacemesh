...
func (m *MockactivationDB) GetAtxTimestamp(arg0 types.ATXID) (time.Time, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAtxTimestamp", arg0)
...
func (mr *MockactivationDBMockRecorder) GetAtxTimestamp(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAtxTimestamp", reflect.TypeOf((*MockactivationDB)(nil).GetAtxTimestamp), arg0)
}
...
func (m *MockactivationDB) GetNodeAtxIDForEpoch(arg0 types.NodeID, arg1 types.EpochID) (types.ATXID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNodeAtxIDForEpoch", arg0, arg1)
...
func (mr *MockactivationDBMockRecorder) GetNodeAtxIDForEpoch(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNodeAtxIDForEpoch", reflect.TypeOf((*MockactivationDB)(nil).GetNodeAtxIDForEpoch), arg0, arg1)
}
