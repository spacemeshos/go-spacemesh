...
func (t *LayerOpinion2) EncodeScale(enc *scale.Encoder) (total int, err error) {
	...
	{
		n, err := scale.EncodeBool(enc, t.Certified)
		if err != nil {
			return total, err
		}
		total += n
	...
	{
		n, err := scale.EncodeByteArray(enc, t.CertBlock[:])
		if err != nil {
			return total, err
		}
		total += n
...
func (t *LayerOpinion2) DecodeScale(dec *scale.Decoder) (total int, err error) {
	...
	{
		n, err := scale.DecodeByteArray(dec, t.CertBlock[:])
		if err != nil {
			return total, err
		}
		total += n
...
func (t *CertRequest) EncodeScale(enc *scale.Encoder) (total int, err error) {
	{
...
func (t *CertRequest) DecodeScale(dec *scale.Decoder) (total int, err error) {
	{
		field, n, err := scale.DecodeCompact32(dec)
		if err != nil {
			return total, err
