...
func New(ctx context.Context, logger log.Log, h host.Host, cfg PubsubConfig, isBootnode bool) (*PubSub, error) {
...
func getOptions(cfg PubsubConfig, isBootnode bool) []pubsub.Option {
