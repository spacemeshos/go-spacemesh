...
func (t *MalfeasanceProofV2) EncodeScale(enc *scale.Encoder) (total int, err error) {
	{
...
func (t *MalfeasanceProofV2) DecodeScale(dec *scale.Decoder) (total int, err error) {
	{
