...
type Handler struct {
	...
	handlers map[MalfeasanceType]HandlerV1
...
func NewHandler(
	...
	return &Handler{
		...
		handlers: make(map[MalfeasanceType]HandlerV1),
	}
}

func (h *Handler) RegisterHandler(malfeasanceType MalfeasanceType, handler HandlerV1) {
