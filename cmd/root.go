...
func AddCommands(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().Uint64Var(&config.POST.BitsPerLabel, "post-bits-per-label",
	...
	cmd.PersistentFlags().Uint64Var(&config.POST.MinNumUnits, "post-min-numunits",
		config.POST.MinNumUnits, "")
	cmd.PersistentFlags().Uint64Var(&config.POST.MaxNumUnits, "post-max-numunits",
		config.POST.MaxNumUnits, "")
	cmd.PersistentFlags().Uint64Var(&config.POST.K1, "post-k1",
		config.POST.K1, "")
	cmd.PersistentFlags().Uint64Var(&config.POST.K2, "post-k2",
		config.POST.K2, "")
	...
	cmd.PersistentFlags().Uint64Var(&config.SMESHING.Opts.NumUnits, "smeshing-opts-numunits",
		config.SMESHING.Opts.NumUnits, "")
	cmd.PersistentFlags().Uint64Var(&config.SMESHING.Opts.NumFiles, "smeshing-opts-numfiles",
