...
func AddCommands(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().BoolVar(&config.P2P.NoNatPort, "no-natport",
		config.P2P.NoNatPort, "disable nat port-mapping (if enabled upnp protocol is used to connect with router)")
