...
func AddCommands(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().
		BoolVar(&cfg.P2P.PrivateNetwork, "p2p-private-network", cfg.P2P.PrivateNetwork, "discovery will work in private mode. mostly useful for testing, don't set in public networks")
